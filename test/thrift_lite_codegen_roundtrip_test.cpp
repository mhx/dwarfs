...
#include <dwarfs/gen-cpp-lite/metadata_lite.h>
#include <dwarfs/gen-cpp-lite/thrift_lite_test.h>
...
TEST(generated, enum_traits_contains_all_members_in_decl_order) {
...
TEST(generated, compact_roundtrip_smoke_test_message) {
  ...
  msg.records().value().push_back(gen::BigRecord{});
