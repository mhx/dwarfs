...
if(WITH_ALL_BENCHMARKS AND NOT WIN32)
  add_library(dwarfs_follybenchmark_lite OBJECT
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/folly/folly/detail/ThreadLocalDetail.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/folly/folly/detail/UniqueInstance.cpp
    ${CMAKE_CURRENT_SOURCE_DIR}/folly/folly/detail/thread_local_globals.cpp
  ...
  target_compile_definitions(dwarfs_follybenchmark_lite PRIVATE -D_FORTIFY_SOURCE=0)
  target_link_libraries(dwarfs_follybenchmark_lite PUBLIC dwarfs_folly_lite gflags)
