...
function(add_thrift_lite_library idlfile)
  ...
  list(APPEND _THRIFT_SRC
    ${_THRIFT_GENERATED_DIR}/thrift/${_THRIFT_OUTPUT_PATH}/gen-cpp-lite/${_THRIFTNAME}.h
    ${_THRIFT_GENERATED_DIR}/thrift/${_THRIFT_OUTPUT_PATH}/gen-cpp-lite/${_THRIFTNAME}.cpp
  )
  ...
  if(DWARFS_GIT_BUILD)
    ...
    add_custom_command(
      ...
      COMMAND "${_PYTHON_EXE}" ${CMAKE_CURRENT_SOURCE_DIR}/cmake/thrift-lite.py
                  ...
                  --header-dir ${CMAKE_CURRENT_BINARY_DIR}/thrift/${_THRIFT_OUTPUT_PATH}/gen-cpp-lite
                  --source-dir ${CMAKE_CURRENT_BINARY_DIR}/thrift/${_THRIFT_OUTPUT_PATH}/gen-cpp-lite
      COMMENT "Running thrift lite compiler on ${_THRIFTNAME}.xml [cpp]"
      DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/thrift/${_THRIFT_OUTPUT_PATH}/_keep_${_THRIFTNAME}
              ${CMAKE_CURRENT_SOURCE_DIR}/cmake/thrift-lite.py
