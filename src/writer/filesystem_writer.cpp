...
class fsblock {
 public:
  fsblock(section_type type, block_compressor const& bc,
          ...
          std::move_only_function<void(size_t)> set_block_cb = nullptr);
...
class raw_fsblock : public fsblock::impl {
 public:
  raw_fsblock(section_type type, block_compressor const& bc,
              ...
              std::shared_ptr<compression_progress> pctx,
              std::move_only_function<void(size_t)> set_block_cb)
      : type_{type}
      , bc_{bc}
 ...
 private:
  ...
  std::move_only_function<void(size_t)> set_block_cb_;
