    ...
    charts = [
        {
            ...
            "categories": [".tar.gz\n(pigz -9)", ".tar.zst\n(--long=31 -22)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(lzma)", "DwarFS\n(zstd)"],
            "values": [48629/299, 48629/486, 48629/1407, 48629/337, 48629/133, 48629/303],
            "decimals": 1,
            "units": "MiB/s",
        ...
        },
        {
            ...
            "categories": [".tar.gz\n(pigz -9)", ".tar.zst\n(--long=31 -22)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(lzma)", "DwarFS\n(zstd)"],
            "values": [47.49/12.17, 47.49/0.387, 47.49/1.219, 47.49/3.245, 47.49/0.310, 47.49/0.352],
            "decimals": 1,
            "units": "",
        ...
        },
        {
            ...
            "categories": [".tar.gz\n(pigz -9)", ".tar.zst\n(--long=31 -22)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(lzma)", "DwarFS\n(zstd)"],
            "values": [127, None, 3.638, 0.011, 0.420, 0.009],
            "decimals": 3,
            "units": "seconds",
            "filename": "perl_mount_time.svg",
        },
        {
            "title": "Perl • Lookup speed (higher is better)",
            "categories": [".tar.gz\n(pigz -9)", ".tar.zst\n(--long=31 -22)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(lzma)", "DwarFS\n(zstd)"],
            "values": [1926378/5.67, None, 1926378/5.695, 1926378/5.311, 1926378/2.8, 1926378/2.821],
            "decimals": 0,
            "units": "files/second",
            "filename": "perl_lookup_speed.svg",
        },
        {
            "title": "Perl • Random access speed (higher is better)",
            "categories": [".tar.gz\n(pigz -9)", ".tar.zst\n(--long=31 -22)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(lzma)", "DwarFS\n(zstd)"],

            "values": [None, None, 2642/(5*3600), 2642/1.541, 2642/4.33, 2642/1.134],
            "decimals": 2,
            "units": "MiB/s",
        ...
        #########################################################################################
        {
            ...
            "categories": [".tar.gz\n(pigz -9)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(--categorize)"],
            "values": [3146/5.34, 3146/381, 3146/19.52, 3146/3.98],
            "decimals": 1,
            "units": "MiB/s",
        ...
        },
        {
            ...
            "categories": [".tar.gz\n(pigz -9)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(--categorize)"],
            "values": [3146/13.7, 3146/110, 3146/0.774, 3146/1.32],
            "decimals": 0,
            "units": "MiB/s",
        ...
        },
        {
            ...
            "categories": [".tar.gz\n(pigz -9)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(--categorize)"],
            "values": [3.072/2.725, 3.072/2.255, 3.072/2.711, 3.072/1.664],
            "decimals": 2,
            "units": "",
        ...
        },
        {
            ...
            "categories": [".tar.gz\n(pigz -9)", "7zip\n(-mx=7)", "SquashFS\n(1M,zstd)", "DwarFS\n(--categorize)"],
            "values": [3146/182, 3146/1842, 3146/2.81, 3146/2.64],
            "decimals": 2,
            "units": "MiB/s",
